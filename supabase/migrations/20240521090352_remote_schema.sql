...
CREATE POLICY "Enable delete for users based on user_id" ON "public"."quests" FOR DELETE TO "authenticated" USING (true);

CREATE POLICY "Enable insert for authenticated users only" ON "public"."quests" FOR INSERT TO "authenticated" WITH CHECK (true);
...
CREATE POLICY "Enable read access for all users" ON "public"."quests" FOR SELECT TO "authenticated" USING (true);
...
CREATE POLICY "Enable update for users based on email" ON "public"."quests" FOR UPDATE TO "authenticated" USING (true) WITH CHECK (true);
