              ...
              <ul className="space-y-2">
                <li key="1st">
                  ...
                  >
                      ...
                      {/* <div className="flex"> */}
                        <div className="w-[151px] h-[31px] font-inter font-normal text-sm leading-[19px] flex items-center text-center bg-gradient-to-r from-[#ECB5FF] to-[#8E6D99] bg-clip-text text-transparent order-2 flex-none flex-grow-0 z-2">
                ...
                <li key='2nd'>
                  <div className="font-inter text-sm text-center bg-gradient-to-r from-[#ECB5FF] to-[#8E6D99] bg-clip-text text-transparent">
                ...
                <li key="1st">
                  ...
                  >
                      <div className="w-5 h-5 text-fuchsia-200 group-hover:text-white-400 shrink-0">
                        ...
                        <div className="w-[151px] h-[31px] font-inter font-normal text-sm  flex items-center text-center bg-gradient-to-r from-[#ECB5FF] to-[#8E6D99] bg-clip-text text-transparent order-2 flex-none flex-grow-0 z-2">
